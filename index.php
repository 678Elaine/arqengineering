...
<html class="no-js" lang="zxx">
   ...
   <body>
    ...
    <main>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="single-service-cap mb-30">
                            <div class="service-img">
                                <img src="view/assets/img/service/servicess1.png" alt="">
                            </div>
                            ...
                            <div class="service-icon">
                                <img src="view/assets/img/icon/services_icon1.png" alt="">
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="single-service-cap mb-30">
                            <div class="service-img">
                                <img src="view/assets/img/service/servicess2.png" alt="">
                            </div>
                            <div class="service-cap">
                                <h4><a href="services_details.html">Electrical techniques & implementation</a></h4>
                                <a href="services_details.html" class="more-btn">Read More <i class="ti-plus"></i></a>
                            </div>
                            <div class="service-icon">
                                <img src="view/assets/img/icon/services_icon1.png" alt="">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="single-service-cap mb-30">
                            <div class="service-img">
                                <img src="view/assets/img/service/servicess3.png" alt="">
                            </div>
                            <div class="service-cap">
        ...
        <section class="support-company-area fix pt-10">
            <div class="support-wrapper align-items-end">
                ...
                <div class="right-content">
                    <!-- img -->
                    <div class="right-img">
                        <img src="view/assets/img/gallery/safe_in.png" alt="">
                    </div>
                                ...
                                <div class="project-caption">
                                    <div class="row">
                                        <div class="col-lg-4 col-md-6">
                                            <div class="single-project mb-30">
                                                <div class="project-img">
                                                    <img src="view/assets/img/gallery/project1.png" alt="">
                                                </div>
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            <div class="single-project mb-30">
                                                <div class="project-img">
                                                    <img src="view/assets/img/gallery/project2.png" alt="">
                                                </div>
                                                <div class="project-cap">
                                                    <a href="project_details.html" class="plus-btn"><i class="ti-plus"></i></a>
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            <div class="single-project mb-30">
                                                <div class="project-img">
                                                    <img src="view/assets/img/gallery/project3.png" alt="">
                                                </div>
                                                <div class="project-cap">
                                                    <a href="project_details.html" class="plus-btn"><i class="ti-plus"></i></a>
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            <div class="single-project mb-30">
                                                <div class="project-img">
                                                    <img src="view/assets/img/gallery/project4.png" alt="">
                                                </div>
                                                <div class="project-cap">
                                                    <a href="project_details.html" class="plus-btn"><i class="ti-plus"></i></a>
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            <div class="single-project mb-30">
                                                <div class="project-img">
                                                    <img src="view/assets/img/gallery/project5.png" alt="">
                                                </div>
                                                <div class="project-cap">
                                                    <a href="project_details.html" class="plus-btn"><i class="ti-plus"></i></a>
                                                   <h4><a href="project_details.html">Shangai Tower</a></h4>
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            <div class="single-project mb-30">
                                                <div class="project-img">
                                                    <img src="view/assets/img/gallery/project6.png" alt="">
                                                </div>
                                                <div class="project-cap">
                                                    <a href="project_details.html" class="plus-btn"><i class="ti-plus"></i></a>
                                                   <h4><a href="project_details.html">Floride Chemicals</a></h4>
                                ...
                                <div class="project-caption">
                                    <div class="row">
                                        <div class="col-lg-4 col-md-6">
                                            <div class="single-project mb-30">
                                                <div class="project-img">
                                                    <img src="view/ssets/img/gallery/project1.png" alt="">
                                                </div>
                                                <div class="project-cap">
                                                    <a href="project_details.html" class="plus-btn"><i class="ti-plus"></i></a>
                                                   <h4><a href="project_details.html">Floride Chemicals</a></h4>
        ...
        <section class="contact-with-area" data-background="view/assets/img/gallery/section-bg2.jpg">
            <div class="container">
                <div class="row">
                        ...
                        <div class="contact-us-caption">
                            <div class="team-info mb-30 pt-45">
                                ...
                                <div class="section-tittle section-tittle4">
                                    ...
                                    <span class="back-text">Fun Fact</span>
                                </div>
                                <p> Electrical engineers are different from electricians and the knowledge you gain studying Electrical Engineering is applicable to fields outside engineering</p>
        ...
        <div class="count-area">
            <div class="container">
                <div class="count-wrapper count-bg" data-background="view/assets/img/gallery/section-bg3.jpg">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-">
                        <div class="single-team mb-30">
                            <div class="team-img">
                                <img src="view/assets/img/team/team1.png" alt="">
                            </div>
                            <div class="team-caption">
                                <span>CEO </span>
                                <h3>Ebenezer Roberts</h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-">
                        <div class="single-team mb-30">
                            <div class="team-img">
                                <img src="view/assets/img/team/team2.png" alt="">
                            </div>
                            <div class="team-caption">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-">
                        <div class="single-team mb-30">
                            <div class="team-img">
                                <img src="view/assets/img/team/team3.png" alt="">
                            </div>
                            <div class="team-caption">
                                <span> COO </span>
                                <h3>Elorm Kumahor</h3>
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-6">
                        ...
                        <div class="single-news mb-30">
                            <div class="news-img">
                                <img src="view/assets/img/david/david_1.png" alt="">
                            ...
                            <div class="news-caption">
                                ...
                                <h2><a href="single-blog.html">Footprints in Accra</a></h2>
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6">
                        ...
                        <div class="single-news mb-30">
                            <div class="news-img">
                                <img src="view/assets/img/david/david_2.png" alt="">
                                <div class="news-date text-center">
                                    <span>24</span>
                                    <p>Now</p>
                                </div>
                            ...
                            <div class="news-caption">
                                ...
                                <h2><a href="single-blog.html">Footprints in China</a></h2>
                                <a href="single-blog.html" class="d-btn">Read more » </a>
                            </div>
                        </div>
                    </div>
