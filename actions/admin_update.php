                    ...
                    <div class="col-lg-8">
                        <form class="form-contact contact_form" action="../actions/orderprocess.php" method="post"  novalidate="novalidate">
                            ...
                            <div class="col-12">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <input class="form-control w-100" name="updateresponse" id="updateresponse" cols="30" rows="9" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Description'" placeholder=" Enter Description"></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group mt-3">
                                <input type="submit" class="button button-contactForm boxed-btn"  name="updateorder">
                            </div>
                        </form>
                    </div>
            </div>
