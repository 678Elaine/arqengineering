...
$order= select_oneorder($id);

?>



Message: <h4><?php echo $order["order_desc"]    ?></h4>
        ...
        <div class="services-area1 section-padding30">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-12">
                        <h2 class="contact-title">Help</h2>
                    </div>
                    <div class="col-lg-8">
                        <form class="form-contact contact_form" action="../actions/orderprocess.php" method="post"  novalidate="novalidate">
                            <div class="row">
                            <div class="col-12">
                                    <div class="form-group">
                                        <input class="form-control w-100" type ="hidden" name="orderid" id="orderid" cols="30" rows="9" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Description'" placeholder=" Enter Description" value = "<?php echo $_GET['id']; ?>"></textarea>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                        <input class="form-control w-100" name="response" id="response" cols="30" rows="9" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Description'" placeholder=" Enter Description"></textarea>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <input class="form-control valid" name="customerid" id="customerid" type="email" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter email address'" placeholder="Email">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group mt-3">
                                <input type="submit" class="button button-contactForm boxed-btn"  name="save">
                            </div>
                        </form>
                    </div>
            </div>
