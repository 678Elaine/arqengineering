...
function insert_customer($username,$usermail,$userpassword,$usercountry,$usercity, $usernum, $userorg, $role)
{
    $customer = new Customer();
    return $customer->insert_customer_class($username,$usermail,$userpassword,$usercountry,$usercity, $usernum, $userorg, $role);
}
