                                ...
                                <div class="main-menu f-right d-none d-lg-block">
                                    <nav> 
                                        <ul id="navigation">                                                                                                                   
                                            ...
                                            <li><a href="../view/userprojectdetails.php"> Orders </a>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="section-tittle mb-55">
                            ...
                            <span class="back-text">appointment</span>
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <form class="form-contact contact_form" method="post" action="../actions/orderprocess.php"   novalidate="novalidate">
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        <input type ="text" class="form-control w-100" name="name" id="name" cols="30" rows="9" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Your name'" placeholder=" Your name "></textarea>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <input type= "email" class="form-control valid" name="businessname" id="businessname" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter your Business name'" placeholder="Enter your Business name">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <input class="form-control" name="date" id="date" type="date" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter the date'" placeholder="Enter the date">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                        <input class="form-control" name="time" id="time" type="time" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter the time'" placeholder="Enter the time">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group mt-3">
                                <input type="submit" class="button button-contactForm boxed-btn"  name="book">
                            </div>
                        </form>
                    </div>
            </div>
